...
export default function Home() {
  const components = [
    ...
    {
      id: "title-carousel-cards-cta",
      name: "TitleCarouselCardsCTA",
      description:
        "Componente de carrusel de tarjetas con título estilizado, iconos, descripciones y botones CTA. Perfecto para secciones de ayuda, FAQs y características.",
